...
<div style="background:url('${pageContext.request.contextPath}/images/login.jpg')">
		<form action="${pageContext.request.contextPath}/ssh_online_cangku_sys/login!login" method="post">
			<table border="0px" width="1321" height="585" >
			  ...
			  <tr height="10">
				...
				<tr height="10">
                    ...
                    <td width="5%">&nbsp;验证码：</td>
                    <td><input type="text" value="${imageCode }" name="imageCode" id="imageCode" size="5" />&nbsp;<img onclick="javascript:loadimage();"  title="换一张试试" name="randImage" id="randImage" src="${pageContext.request.contextPath}/pages/admin/image.jsp" width="60" height="20" border="1" align="absmiddle"></td>
                    <td width="50%"></td>
			  </tr>
                <tr>
