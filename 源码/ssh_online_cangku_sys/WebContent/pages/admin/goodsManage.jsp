...
<script type="text/javascript">
	...
	function deleteGoods(){
		...
		$.messager.confirm("系统提示","您确认要删掉这<font color=red>"+selectedRows.length+"</font>条数据吗？",function(r){
			if(r){
				$.post("${pageContext.request.contextPath}/ssh_online_cangku_sys/goods!delete",{delIds:ids},function(result){
					if(result.success){
	...
	function openGoodsAddDialog(){
		...
		url="${pageContext.request.contextPath}/ssh_online_cangku_sys/goods!save";
	}
	...
	function openGoodsModifyDialog(){
		...
		url="${pageContext.request.contextPath}/ssh_online_cangku_sys/goods!save?id="+row.id;
	}
	...
	function exportData(){
		window.open('${pageContext.request.contextPath}/ssh_online_cangku_sys/goods!export')
	}
...
<body style="margin: 5px;">
	<table style="height:423px; width:1160px" id="dg" title="商品管理" class="easyui-datagrid" fitColumns="true"
	 pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/ssh_online_cangku_sys/goods" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="tb">
		...
		<div>&nbsp;商品编号：&nbsp;<input type="text" name="s_goodsId" id="s_goodsId" size="10" />
			...
			&nbsp;供应商：&nbsp;<input class="easyui-combobox" id="s_proId" name="s_proId" size="10" data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'proName',url:'${pageContext.request.contextPath}/ssh_online_cangku_sys/provider!providerComboList'"/>
			&nbsp;商品类别：&nbsp;<input class="easyui-combobox" id="s_typeId" name="s_typeId" style="width:100px;"  size="10" data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'typeName',url:'${pageContext.request.contextPath}/ssh_online_cangku_sys/goodsType!goodsTypeComboList'"/>
	...
	closed="true" buttons="#dlg-buttons">
		<form id="fm" method="post">
			<table cellspacing="5px;">
				...
				<tr>
					<td>供应商：</td>
					<td><input class="easyui-combobox" id="proId" name="goods.proId" size="10" data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'proName',url:'${pageContext.request.contextPath}/ssh_online_cangku_sys/provider!providerComboList'"/></td>
					
					<td>商品类别：</td>
					<td><input class="easyui-combobox" id="typeId" name="goods.typeId" style="width:100px;"  size="10" data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'typeName',url:'${pageContext.request.contextPath}/ssh_online_cangku_sys/goodsType!goodsTypeComboList'"/></td>
				</tr>
				<tr>
	...
	<div id="dlg3" class="easyui-dialog" style="width:400px;height:180px;padding:10px 20px"
        ...
        <form id="uploadForm" action="${pageContext.request.contextPath}/ssh_online_cangku_sys/goods!upload" method="post" enctype="multipart/form-data">
        	<table>
        		<tr>
        			<td>下载模版：</td>
