...
<script type="text/javascript">
	...
	function deleteProvider(){
		...
		$.messager.confirm("系统提示","您确认要删除这<font color=red>"+selectedRows.length+"</font>条数据吗?",function(r){
			if(r){
				$.post("${pageContext.request.contextPath}/ssh_online_cangku_sys/provider!delete",{delIds:ids},function(result){
					if(result.success){
	...
	function openProviderAddDialog(){
		...
		url="${pageContext.request.contextPath}/ssh_online_cangku_sys/provider!save";
	}
	...
	function openProviderModifyDialog(){
		...
		url="${pageContext.request.contextPath}/ssh_online_cangku_sys/provider!save?id="+row.id;
	}
	...
	function exportData(){
		window.open('${pageContext.request.contextPath}/ssh_online_cangku_sys/provider!export')
	}
</script>
</head>
<body style="margin: 5px;">
	<table style="height:423px; width:1160px" id="dg" title="供应商管理" class="easyui-datagrid" fitColumns="true"
	 pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/ssh_online_cangku_sys/provider" toolbar="#tb">
		<thead>
			<tr>
