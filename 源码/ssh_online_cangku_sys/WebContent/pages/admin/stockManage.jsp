...
<script type="text/javascript">
	...
	function deleteStock(){
		...
		$.messager.confirm("系统提示","您确认要删除这<font color=red>"+selectedRows.length+"</font>条数据吗?",function(r){
			if(r){
				$.post("${pageContext.request.contextPath}/ssh_online_cangku_sys/stock!delete",{delIds:ids},function(result){
					if(result.success){
	...
	function openStockAddDialog(){
		...
		url="${pageContext.request.contextPath}/ssh_online_cangku_sys/stock!save";
	}
	...
	function openStockModifyDialog(){
		...
		url="${pageContext.request.contextPath}/ssh_online_cangku_sys/stock!save?id="+row.id;
	}
...
<body style="margin: 5px;">
	<table style="height:423px; width:1160px" id="dg1" title="库存管理" class="easyui-datagrid" fitColumns="true"
	 pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/ssh_online_cangku_sys/stock" toolbar="#tb">
		<thead>
			<tr>
	...
	closed="true" buttons="#dlg-buttons">
		<form id="fm" method="post">
			<table cellspacing="5px;">
				<tr>
					<td>商品名称：</td>
					<td><input class="easyui-combobox" id="goodsId" name="stock.goodsId" size="10" data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'goodsName',url:'${pageContext.request.contextPath}/ssh_online_cangku_sys/goods!goodsComboList'"/></td>
				...
				<tr>
					<td colspan="3">
						<table style="height:250px; width:540px" id="dg2" title="商品选择" class="easyui-datagrid" fitColumns="true"
	 							pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/ssh_online_cangku_sys/stock">
	 							<thead>
									<tr>
