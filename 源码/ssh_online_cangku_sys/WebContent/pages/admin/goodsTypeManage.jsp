...
<script type="text/javascript">
	...
	function deleteGoodsType(){
		...
		$.messager.confirm("系统提示","您确认要删除这<font color=red>"+selectedRows.length+"</font>条数据吗?",function(r){
			if(r){
				$.post("${pageContext.request.contextPath}/ssh_online_cangku_sys/goodsType!delete",{delIds:ids},function(result){
					if(result.success){
	...
	function openGoodsTypeAddDialog(){
		...
		url="${pageContext.request.contextPath}/ssh_online_cangku_sys/goodsType!save";
	}
	...
	function openGoodsTypeModifyDialog(){
		...
		url="${pageContext.request.contextPath}/ssh_online_cangku_sys/goodsType!save?id="+row.id;
	}
	...
	function exportData(){
		window.open('${pageContext.request.contextPath}/ssh_online_cangku_sys/goodsType!export')
	}
</script>
</head>
<body>
	...
	<table style="height:423px; width:1160px;" id="dg" title="商品类别管理" class="easyui-datagrid" fitColumns="true"
	 pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/ssh_online_cangku_sys/goodsType" toolbar="#tb">
		<thead>
			<tr>
